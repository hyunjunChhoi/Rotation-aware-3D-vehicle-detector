...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=_b('\n\x1asecond/protos/target.proto\x12\rsecond.protos\x1a\x1bsecond/protos/anchors.proto\x1a\x1esecond/protos/similarity.proto\"\xb0\x07\n\x0c\x43lassSetting\x12G\n\x17\x61nchor_generator_stride\x18\x01 \x01(\x0b\x32$.second.protos.AnchorGeneratorStrideH\x00\x12\x45\n\x16\x61nchor_generator_range\x18\x02 \x01(\x0b\x32#.second.protos.AnchorGeneratorRangeH\x00\x12,\n\tno_anchor\x18\x03 \x01(\x0b\x32\x17.second.protos.NoAnchorH\x00\x12O\n\x1cregion_similarity_calculator\x18\x04 \x01(\x0b\x32).second.protos.RegionSimilarityCalculator\x12\x1b\n\x13use_multi_class_nms\x18\x05 \x01(\x08\x12\x16\n\x0euse_rotate_nms\x18\x06 \x01(\x08\x12\x18\n\x10nms_pre_max_size\x18\x07 \x01(\x05\x12\x19\n\x11nms_post_max_size\x18\x08 \x01(\x05\x12\x1b\n\x13nms_score_threshold\x18\t \x01(\x02\x12\x19\n\x11nms_iou_threshold\x18\n \x01(\x02\x12\x19\n\x11matched_threshold\x18\x0b \x01(\x02\x12\x1b\n\x13unmatched_threshold\x18\x0c \x01(\x02\x12\x12\n\nclass_name\x18\r \x01(\t\x12\x18\n\x10\x66\x65\x61ture_map_size\x18\x0e \x03(\x03\x12$\n\x1cnms_train_first_pre_max_size\x18\x0f \x01(\x05\x12%\n\x1dnms_train_first_post_max_size\x18\x10 \x01(\x05\x12%\n\x1dnms_train_second_pre_max_size\x18\x11 \x01(\x05\x12&\n\x1enms_train_second_post_max_size\x18\x12 \x01(\x05\x12#\n\x1bnms_test_first_pre_max_size\x18\x13 \x01(\x05\x12$\n\x1cnms_test_first_post_max_size\x18\x14 \x01(\x05\x12$\n\x1cnms_test_second_pre_max_size\x18\x15 \x01(\x05\x12%\n\x1dnms_test_second_post_max_size\x18\x16 \x01(\x05\x12\x1f\n\x17nms_first_iou_threshold\x18\x17 \x01(\x02\x12 \n\x18nms_second_iou_threshold\x18\x18 \x01(\x02\x42\x12\n\x10\x61nchor_generator\"\x88\x05\n\x0eTargetAssigner\x12\x33\n\x0e\x63lass_settings\x18\x01 \x03(\x0b\x32\x1b.second.protos.ClassSetting\x12 \n\x18sample_positive_fraction\x18\x02 \x01(\x02\x12\x13\n\x0bsample_size\x18\x03 \x01(\r\x12\x18\n\x10\x61ssign_per_class\x18\x04 \x01(\x08\x12\x19\n\x11nms_pre_max_sizes\x18\x05 \x03(\x03\x12\x1a\n\x12nms_post_max_sizes\x18\x06 \x03(\x03\x12\x1c\n\x14nms_score_thresholds\x18\x07 \x03(\x03\x12\x1a\n\x12nms_iou_thresholds\x18\x08 \x03(\x03\x12%\n\x1dnms_train_first_pre_max_sizes\x18\t \x03(\x05\x12&\n\x1enms_train_first_post_max_sizes\x18\n \x03(\x05\x12&\n\x1enms_train_second_pre_max_sizes\x18\x0b \x03(\x05\x12\'\n\x1fnms_train_second_post_max_sizes\x18\x0c \x03(\x05\x12$\n\x1cnms_test_first_pre_max_sizes\x18\r \x03(\x05\x12%\n\x1dnms_test_first_post_max_sizes\x18\x0e \x03(\x05\x12%\n\x1dnms_test_second_pre_max_sizes\x18\x0f \x03(\x05\x12&\n\x1enms_test_second_post_max_sizes\x18\x10 \x03(\x05\x12 \n\x18nms_first_iou_thresholds\x18\x11 \x03(\x02\x12!\n\x19nms_second_iou_thresholds\x18\x12 \x03(\x02\x62\x06proto3')
  ,
...
_CLASSSETTING = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='nms_train_first_pre_max_size', full_name='second.protos.ClassSetting.nms_train_first_pre_max_size', index=14,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='nms_train_first_post_max_size', full_name='second.protos.ClassSetting.nms_train_first_post_max_size', index=15,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='nms_train_second_pre_max_size', full_name='second.protos.ClassSetting.nms_train_second_pre_max_size', index=16,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='nms_train_second_post_max_size', full_name='second.protos.ClassSetting.nms_train_second_post_max_size', index=17,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='nms_test_first_pre_max_size', full_name='second.protos.ClassSetting.nms_test_first_pre_max_size', index=18,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='nms_test_first_post_max_size', full_name='second.protos.ClassSetting.nms_test_first_post_max_size', index=19,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='nms_test_second_pre_max_size', full_name='second.protos.ClassSetting.nms_test_second_pre_max_size', index=20,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='nms_test_second_post_max_size', full_name='second.protos.ClassSetting.nms_test_second_post_max_size', index=21,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='nms_first_iou_threshold', full_name='second.protos.ClassSetting.nms_first_iou_threshold', index=22,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='nms_second_iou_threshold', full_name='second.protos.ClassSetting.nms_second_iou_threshold', index=23,
...
_TARGETASSIGNER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='nms_train_first_pre_max_sizes', full_name='second.protos.TargetAssigner.nms_train_first_pre_max_sizes', index=8,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='nms_train_first_post_max_sizes', full_name='second.protos.TargetAssigner.nms_train_first_post_max_sizes', index=9,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='nms_train_second_pre_max_sizes', full_name='second.protos.TargetAssigner.nms_train_second_pre_max_sizes', index=10,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='nms_train_second_post_max_sizes', full_name='second.protos.TargetAssigner.nms_train_second_post_max_sizes', index=11,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='nms_test_first_pre_max_sizes', full_name='second.protos.TargetAssigner.nms_test_first_pre_max_sizes', index=12,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='nms_test_first_post_max_sizes', full_name='second.protos.TargetAssigner.nms_test_first_post_max_sizes', index=13,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='nms_test_second_pre_max_sizes', full_name='second.protos.TargetAssigner.nms_test_second_pre_max_sizes', index=14,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='nms_test_second_post_max_sizes', full_name='second.protos.TargetAssigner.nms_test_second_post_max_sizes', index=15,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='nms_first_iou_thresholds', full_name='second.protos.TargetAssigner.nms_first_iou_thresholds', index=16,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='nms_second_iou_thresholds', full_name='second.protos.TargetAssigner.nms_second_iou_thresholds', index=17,
